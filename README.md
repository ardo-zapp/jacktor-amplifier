...
- Repositori ini **tidak** menyertakan firmware "ESP32 Panel Bridge" (bridge Android ↔ Amplifier). Fitur seperti USB-ID toggle (GPIO13), VBUS sense (GPIO34), trigger tombol power Android (GPIO32), indikator LED panel, dan jembatan UART Android ↔ Amplifier hidup di repo terpisah.
- Aplikasi UI panel utama (Android) tidak termasuk di sini.
